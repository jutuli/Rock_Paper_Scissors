      ...
      <div className="choices mt-8 flex justify-around gap-20">
        <button className={`${buttonDesign} `}>
          <img
            ...
            alt="Rock"
            className="size-30 rotate-270 transition-transform duration-300 group-hover:scale-130"
          />
        </button>
        <button className={buttonDesign}>
          <img
            ...
            alt="Paper"
            className="size-30 transition-transform duration-300 group-hover:scale-130"
          />
        </button>
        <button className={buttonDesign}>
          <img
